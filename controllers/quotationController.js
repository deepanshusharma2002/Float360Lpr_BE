...
const createQuotation = async (req, res, next) => {
  ...
  try {
    ...
    const updatedItemdata = ItemData?.filter((item) => item.item_code !== "")?.map((item) => ({
      quo_id: lastInsertedId || null,
      quo_num: quotation_series || null,
      rfq_id: rfq_id || null,
      vendor_id: vendor_id || null,
      cria_required: item?.cria_req || null,
      rfq_item_id: item.rfq_item_id || null,
      item_type: item.item_type || null,
      item_code: item.item_code || null,
      item_id: item.item_id || null,
      item_name: item.item_name || null,
      opr_qty: item.opr_qty || null,
      item_name_vendor: item.item_name_vendor || null,
      item_name_label: item.item_name_label || null,
      quote_qtd: item.quote_qtd || null,
